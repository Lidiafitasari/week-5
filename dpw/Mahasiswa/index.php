                ...
                <tbody>
                  <?php foreach ($list_data_mahasiswa as $key => $mahasiswa): ?>
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a href="show.php?nim=<?php echo $mahasiswa['nim'] ?>" readonly class="btn btn-dark"><i class="fa fa-info"></i></a>
                          <a href="edit.php?nim=<?php echo $mahasiswa['nim'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                          <a onclick="return confirm('Yakin Menghapus Data Ini')" href="delete.php?nim=<?php echo $mahasiswa['nim'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                      </td>
